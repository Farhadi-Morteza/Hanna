...
namespace Infrastructure
{
    ...
    public class ApiControllerWithDatabaseGenericBase<T> : ApiControllerWithDatabaseBase where T : Models.EntityBase
    {
        public ApiControllerWithDatabaseGenericBase(Data.IUnitOfWork unitOfWork) : base(unitOfWork)
        {
        }
